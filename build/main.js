...
},{"../":26,"../morphdom":20,"../runtime/RenderResult":22,"../runtime/dom-insert":24,"./event-delegation":10,"./update-manager":17,"./util":18,"events-light":2,"listener-tracker":3,"raptor-util/inherit":42}],5:[function(require,module,exports){
'use strict';
...
},{"./nextRepeatedId":14,"./registry":15,"./util":18,"raptor-util/extend":41}],6:[function(require,module,exports){
'use strict';
...
},{"./ComponentDef":5,"./init-components":12}],7:[function(require,module,exports){
var extend = require('raptor-util/extend');
...
},{"raptor-util/extend":41}],8:[function(require,module,exports){
module.exports = [
    /* Mouse Events */
    'click',
    'dblclick',
...
},{"./Component":4,"./State":7,"raptor-util/inherit":42}],10:[function(require,module,exports){
var componentsUtil = require('./util');
...
},{"./bubble":8,"./util":18}],11:[function(require,module,exports){
var componentsUtil = require('./util');
...
},{"../runtime/events":25,"./Component":4,"./defineComponent":9,"./init-components":12,"./registry":15,"./renderer":16,"./util":18}],12:[function(require,module,exports){
'use strict';
...
},{"../runtime/events":25,"./ComponentDef":5,"./event-delegation":10,"./util":18,"warp10/finalize":43}],13:[function(require,module,exports){
'use strict';
...
},{"./defineComponent":9,"./loadComponent":13}],16:[function(require,module,exports){
var componentsUtil = require('./util');
var componentLookup = componentsUtil.$__componentLookup;
var emitLifecycleEvent = componentsUtil.$__emitLifecycleEvent;
...
},{"./ComponentsContext":6,"./nextRepeatedId":14,"./registry":15,"./util":18,"raptor-util/copyProps":40}],17:[function(require,module,exports){
'use strict';
...
},{"../runtime/nextTick":28}],18:[function(require,module,exports){
...
},{"../runtime/vdom/VElement":33,"./specialElHandlers":21}],21:[function(require,module,exports){
...
},{"./dom-insert":24}],23:[function(require,module,exports){
var actualCreateOut;
...
},{"../components/util":19,"raptor-util/extend":41}],25:[function(require,module,exports){
var EventEmitter = require('events-light');
module.exports = new EventEmitter();
},{"events-light":2}],26:[function(require,module,exports){
'use strict';
...
},{"./createOut":23,"./env-init":1,"./events":25,"./loader":27}],27:[function(require,module,exports){
'use strict';
...
},{"./createOut":23,"raptor-util/extend":41}],30:[function(require,module,exports){
var EventEmitter = require('events-light');
...
},{"../RenderResult":22,"./vdom":37,"events-light":2}],31:[function(require,module,exports){
...
},{"./VNode":34,"raptor-util/inherit":42}],32:[function(require,module,exports){
var VNode = require('./VNode');
var inherit = require('raptor-util/inherit');
var extend = require('raptor-util/extend');
...
},{"./VNode":34,"raptor-util/extend":41,"raptor-util/inherit":42}],33:[function(require,module,exports){
var VNode = require('./VNode');
var inherit = require('raptor-util/inherit');
...
},{"./VNode":34,"raptor-util/inherit":42}],34:[function(require,module,exports){
/* jshint newcap:false */
...
},{"../../morphdom/specialElHandlers":21}],35:[function(require,module,exports){
var VNode = require('./VNode');
var inherit = require('raptor-util/inherit');
...
},{"./VNode":34,"raptor-util/inherit":42}],36:[function(require,module,exports){
'use strict';
...
},{"../createOut":23,"../renderable":29,"./AsyncVDOMBuilder":30}],37:[function(require,module,exports){
var VNode = require('./VNode');
...
},{"./VComment":31,"./VDocumentFragment":32,"./VElement":33,"./VNode":34,"./VText":35}],38:[function(require,module,exports){
module.exports = require('./runtime/vdom');
},{"./runtime/vdom":36}],39:[function(require,module,exports){
...
},{"./copyProps":40}],43:[function(require,module,exports){
module.exports = require('./src/finalize');
},{"./src/finalize":44}],44:[function(require,module,exports){
var isArray = Array.isArray;
...
},{"../../node_modules/marko/components/defineComponent":9,"../templates/MarkoTest.marko":47}],46:[function(require,module,exports){
const cmp = require('./components/MarkoTest');
const templ = require('./templates/MarkoTest.marko');
templ.Component = cmp;
console.log(templ);
console.log(templ.renderSync({ name: 'test' }).getNode().firstChild.outerHTML);
},{"./components/MarkoTest":45,"./templates/MarkoTest.marko":47}],47:[function(require,module,exports){
'use strict';
var marko_template = module.exports = require('marko/vdom').t(), marko_component = {}, marko_components = require('marko/components'), marko_registerComponent = marko_components.rc, marko_componentType = marko_registerComponent('/@marko$1.0.0/src/templates/MarkoTest.marko', function () {
        return module.exports;
    });
function render(input, out, __component, component, state) {
    var data = input;
    out.e('H1', { id: __component.id }, 2, 4).t('Hello, ').t(state.name);
}
marko_template._ = marko_components.r(render, { type: marko_componentType }, marko_component);
marko_template.Component = marko_components.c(marko_component, marko_template._);
},{"marko/components":11,"marko/vdom":38}]},{},[45,46]);
